...
// sparkline string. Values are normalized against the slice's own
// min/max range. An empty slice returns an empty string. When all
// values are equal (flat line), renders at mid-height to convey
// "steady" rather than "maxed out."
